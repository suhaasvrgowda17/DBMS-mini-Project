...
(1, 'Tropical Paradise Gateway', 'Maldives', 120000.00, '5 Days / 4 Nights', 'Experience the luxury of overwater villas, crystal-clear turquoise waters, and vibrant marine life with our fully curated tropical Maldives holiday.', 'Luxury', 45, 'https://images.unsplash.com/photo-1514282401047-d79a71a590e8?auto=format&fit=crop&w=800&q=80'),
(2, 'Swiss Alps Majestic Explorer', 'Switzerland', 210000.00, '7 Days / 6 Nights', 'Embark on a breath-taking mountain escape. Ride scenic trains, hike through beautiful valleys, and stay in premium alpine cabins in Zermatt and Interlaken.', 'Adventure', 28, 'https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?auto=format&fit=crop&w=800&q=80'),
(3, 'Ancient Wonders of Kyoto', 'Kyoto, Japan', 160000.00, '6 Days / 5 Nights', 'Immerse yourself in traditional Japanese culture. Visit historic shrines, stroll beneath cherry blossoms, and enjoy high-end Kaiseki dining experiences.', 'Cultural', 30, 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&w=800&q=80'),
(4, 'European Heritage Journey', 'Rome, Italy', 180000.00, '8 Days / 7 Nights', 'Unveil thousands of years of human history. Tour the historic Colosseum, Vatican museums, and enjoy authentic Roman cooking classes in beautiful neighborhoods.', 'Family', 50, 'https://images.unsplash.com/photo-1529260830199-44552e02202e?auto=format&fit=crop&w=800&q=80'),
(5, 'Golden Sands & Heritage', 'Goa, India', 25000.00, '4 Days / 3 Nights', 'Relax on the sun-kissed beaches of Goa. Enjoy vibrant nightlife, historic Portuguese architecture, and exquisite coastal seafood delicacies.', 'Luxury', 60, 'https://images.unsplash.com/photo-1512343879784-a960bf40e7f2?auto=format&fit=crop&w=800&q=80'),
(6, 'God''s Own Country Retreat', 'Kerala, India', 35000.00, '6 Days / 5 Nights', 'Cruise through the serene backwaters in a traditional houseboat, explore lush tea gardens in Munnar, and rejuvenate with authentic Ayurvedic spas.', 'Family', 40, 'https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?auto=format&fit=crop&w=800&q=80'),
(7, 'Heaven on Earth Expedition', 'Kashmir, India', 45000.00, '7 Days / 6 Nights', 'Witness the breathtaking beauty of snow-capped peaks, take a Shikara ride on Dal Lake, and explore the enchanting valleys of Gulmarg and Pahalgam.', 'Adventure', 35, 'https://images.unsplash.com/photo-1566837945700-30058863f538?auto=format&fit=crop&w=800&q=80'),
(8, 'Royal Desert Safari', 'Rajasthan, India', 30000.00, '5 Days / 4 Nights', 'Step into the land of Kings. Explore majestic forts in Jaipur, experience desert safaris in Jaisalmer, and witness the grandeur of Udaipur''s lakes.', 'Cultural', 50, 'https://images.unsplash.com/photo-1477587458883-47145ed94245?auto=format&fit=crop&w=800&q=80');
